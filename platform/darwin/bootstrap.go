...
// Stub names are JSON-escaped so odd names can't break out of the JS literal.
// resolve/reject take (id, result|errString) and settle the matching pending
// promise; the bridge's reply JS calls them directly.
